...
/// Hive CE implementation of [StorageService].
///
...
class HiveStorageService implements StorageService {
  ...
  Future<void> init() async {
    ...
    await _openBox(StorageService.defaultBoxName);
  }

  @override
  Future<T?> read<T>(String key, {String boxName = StorageService.defaultBoxName}) async {
  ...
  Future<void> write<T>({
    required String key,
    required T value,
    String boxName = StorageService.defaultBoxName,
  }) async {
    final box = await _openBox(boxName);
  ...
  @override
  Future<void> delete(String key, {String boxName = StorageService.defaultBoxName}) async {
    final box = await _openBox(boxName);
    await box.delete(key);
  }

  @override
  Future<void> clear({String boxName = StorageService.defaultBoxName}) async {
    final box = await _openBox(boxName);
    await box.clear();
  }
